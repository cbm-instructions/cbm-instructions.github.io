...
![Bauteile](/images/makeit/Steuereinheit.JPG)
...
![Bauteile](/images/makeit/LötstellenPins.JPG)

![Bauteile](/images/makeit/PinsDigi.JPG)

![Bauteile](/images/makeit/PinsStrom.JPG)
...
![Bauteile](/images/makeit/PlatineOben.JPG)

![Bauteile](/images/makeit/PlatineUnten.JPG)

Die nach außen führenden Kabel verlöten wir im nächsten Schritt. Wie Ihr auf den Bildern seht, sind der Kondensator und der Transistor um 90 Grad geknickt und auf die Platine gedrückt. Das ist sehr wichtig, dass die Platine später auch wieder auf den Arduino passt und am Ende in das Gehäuse für unsere Schalteinheit. Um dabei Kurschlüsse zu vermeiden, könnt Ihr ein Stückchen Tesaband an die Stellen kleben auf denen die Teile, nach dem Umbiegen, aufliegen werden. Zum Verbiegen steckt Ihr die Teile am besten erst durch die Platine, verbiegt die Beinchen und lötet die Teile erst dann fest. So könnt Ihr noch etwas anpassen, falls etwas nicht funktioniert.
...
![Bauteile](/images/makeit/AnschlussEmitter.JPG)
...
![Bauteile](/images/makeit/AnschlussEmpfänger.JPG)
...
![Bauteile](/images/makeit/EmpfängerOben.JPG)

![Bauteile](/images/makeit/EmpfängerUnten.JPG)
...
![Bauteile](/images/makeit/NeoPixelPfeil.JPG)
...
![Bauteile](/images/makeit/KleinSeite.JPG)

6. Bohrt nun auch ein Loch mittig auf die Vorderseite.

![Bauteile](/images/makeit/KleinVorn.JPG)
...
![Bauteile](/images/makeit/HousingEmitter.JPG)

8. Verschließt nun die Projektbox mit Hilfe der Schrauben.

![Bauteile](/images/makeit/EmitterOben.JPG)
...
2. Legt nun ein neues Projekt in eurer IDE an und gebt dem Projekt einen Teitel eurer Wahl.
3. Importiert nund die [Ardafruit NeoPixel Library](https://learn.adafruit.com/adafruit-neopixel-uberguide/arduino-library-installation) und die [IR-Library](https://github.com/z3t0/Arduino-IRremote). Wie das funktioniert erfahrt ihr in der Dokumentation zu der von euch gewählten IDE.
...
8. Wenn un alles funktioniert könnt ihr alles an der Treppe verbauen und alle Projektboxen schließen.
...
Für den Einbau bringt ihr alles zur Treppe. Wie ihr genau die Teile verbaut überlassen wir euch. Wir haben unsere Bauteile mit doppelseitigem Klebeband am Trppensockel verbaut. Die Bilder unten geben euch einen besseren Eindruck von unserer Verbauung.

<!--Bilder Verbauung-->

Wichtig ist nur, dass ihr die Lichtschranke sehr genau ausrichtet, da die von uns genutzte LED eine sehr geringe Streuung von nur 5 Grad aufweißt. Platziert also zunächst die Bauteile , markiert die Stelle, an die das Bauteil geklebt werden soll und klebt das Bauteil dann an.
