...
- [Schritt für Schritt Anleitung](#schritt-für-schritt-anleitung)
  ...
  - [2. Schrankinneres erstellen](#2.-schrankinneres-erstellen)
    - [2.1 Innenleben](#2.1-innenleben)
    - [2.2 Entfernungsmesser Box](#2.2-entfernungsmesser-box)
  - [3. Technik konfigurieren](#3.-technik-konfigurieren)
    - [3.1 Raspberry](#3.1-raspberry)
    - [3.2 Arduino Uno](#3.2-arduino-uno)
    - [3.3 ESP32-Cam](#3.3-esp32\-cam)
    - [3.4 Barcode-Scanner](3.4-barcode\-scanner)
    - [3.5 RFID Reader](3.5-rfid-reader)
    - [3.6 Datenbank erstellen](3.6-datenbank-erstellen)
